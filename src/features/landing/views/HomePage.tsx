...
export const HomePage: FC<{ title: string }> = ({ title }) => {
	return (
			...
			<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
				<div class="max-w-2xl w-full bg-white rounded-xl shadow-2xl p-8">
					...
					<p class="text-lg text-gray-600 mb-6">
						A modern web application built with Node.js, Hono, Tailwind CSS, and
						Hotwire.
					</p>
					<div class="space-y-4">
						<div class="bg-green-50 border-l-4 border-green-500 p-4">
							<p class="text-green-700 font-semibold">✅ Node.js Runtime</p>
						</div>
						...
						>
							<p class="text-yellow-700 font-semibold">
								✅ Hotwire Stimulus (check console)
							</p>
						</div>
					</div>
				</div>
